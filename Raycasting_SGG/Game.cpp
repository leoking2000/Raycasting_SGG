	...
	camera(&scene, CanvasWidth, CanvasHeight)
{
	...
	scene.gameobjects.push_back(new Entity(3.0f, 8.0f, 1.0f, 0.0f, std::string("assets//barrel.png")));
	scene.gameobjects.push_back(new Entity(20.0f, 18.0f, 1.0f, 0.0f, std::string("assets//robot.png")));
									
	scene.gameobjects.push_back(new Entity(25.0f, 14.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(25.0f, 11.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(25.0f, 9.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(25.0f, 7.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(26.0f, 14.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(26.0f, 11.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(26.0f, 9.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
	scene.gameobjects.push_back(new Entity(26.0f, 7.0f, 1.0f, 0.0f, std::string("assets//pillar.png")));
